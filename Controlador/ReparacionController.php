...
switch ($_POST['opcion']) {
    case 'consultar':
        ...
        foreach ($datos as $fila) {
            ...
            $tabla .= "<td>" . $fila['tipo_de_comprobante'] . "</td>";
            ...
            <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='Black' class='bi bi-pencil' viewBox='0 0 16 16' onclick='eliminar(" . $fila['id_reparacion'] . ")'>Eliminar>
